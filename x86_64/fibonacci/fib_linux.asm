; nasm -f elf64 -o x fibo-linux.asm && ld -arch x86_64 x -o out_fibo_linux_arch_x86_64 && rm -f x  && ./out_fibo_linux_arch_x86_64

; nasm -f elf64 -o x fibo-linux.asm && ld -s -o out_fibo_linux_s && rm -f x  && ./out_fibo_linux_s

; http://www.beroset.com/asm/fibo-linux.asm
; fibo-linux.asm
;
