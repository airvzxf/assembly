...
echo -e "\n"
echo -e "out_my_solution (46 numbers) x 1,000 repetitions | NASM"
echo -e "----------------------------------------------------------------------"
#time ./out_my_solution
#time ./out_my_solution >/dev/null 2>&1
time for i in {1..1000}; do ./out_my_solution >/dev/null 2>&1; done
...
echo -e "\n"
echo -e "fib_x64_fasm_a (24 numbers) x 1000 repetitions | FASM"
echo -e "Very slow"
echo -e "----------------------------------------------------------------------"
#time ./fib_x64_fasm_a
#time ./fib_x64_fasm_a >/dev/null 2>&1
time for i in {1..1000}; do ./fib_x64_fasm_a >/dev/null 2>&1; done
