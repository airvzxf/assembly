...
SECTION .data
echo_command    db      '/bin/echo', 0h     ; command to execute
echo_arg1       db      '-Hello-', 0h
echo_arg2       db      '-World!-', 0h
echo_arg3       db      '-Argument #3 with spaces-', 0h
...
ls_command      db      '/bin/ls', 0h       ; command to execute
ls_arg1         db      '-l', 0h
